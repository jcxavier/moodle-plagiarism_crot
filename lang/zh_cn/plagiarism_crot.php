...
$string['crot'] = 'Crot反抄袭';
$string['crotexplain'] = 'Crot是一个反抄袭工具：它比较同一机构同学之间的作业拷贝，也能比较来自Internet的拷贝。它使用文档指纹技术处理内部文档比较，使用MSN Live搜索引擎处理全局搜索。<br /><br />更多信息在<a href="http://www.siberiasoft.info">www.siberiasoft.info</a>';

$string['usecrot'] ='启用Crot';
$string['savedconfigsuccess'] = '抄袭设置已保存';
$string['compareinternet'] = '将提交的文件在Internet中比较';
$string['comparestudents'] = '将提交的文件学生间比较';
