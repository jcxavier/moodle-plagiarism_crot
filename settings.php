...
function clean_data(){
    global $DB;
	// cleaning up all the tables for Crot plugin except teachers' settings: delete_records("crot_config")
	$DB->delete_records("crot_files");
    $DB->delete_records("crot_documents");
	$DB->delete_records("crot_fingerprint");
	$DB->delete_records("crot_submission_pair");
	$DB->delete_records("crot_web_documents");
